                            ...
                            <div className="flex items-center space-x-2">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-[280px] border border-gray-300 rounded-md pl-9 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                    />
                                </div>
                                <select
                                    value={statusFilter}
                                ...
                                <input
                                    ...
                                    className="w-[170px] border border-gray-300 rounded-md px-3 py-2 text-sm"
                                />
                                <input
                                    type="date"
                                    value={appliedTo}
