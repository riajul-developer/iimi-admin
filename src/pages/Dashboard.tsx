...
import { User, FileText, Eye,  Clock, XCircle, AlertCircle, Calendar, UserCheck, Send } from 'lucide-react';
...
const Dashboard: React.FC = () => {
    ...
    const chartData = [
        { name: 'Applied', value: dashboardState?.appliedCount ?? 0, fill: '#60A5FA' },      
        { name: 'Scheduled', value: dashboardState?.scheduledCount ?? 0, fill: '#A78BFA' },  
        { name: 'Selected', value: dashboardState?.selectedCount ?? 0, fill: '#4ADE80' },    
        { name: 'Under Review', value: dashboardState?.underReviewCount ?? 0, fill: '#FACC15' }, 
        { name: 'Submitted', value: dashboardState?.submittedCount ?? 0, fill: '#818CF8' },  
        { name: 'Rejected', value: dashboardState?.rejectedCount ?? 0, fill: '#F87171' },   
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-5 sm:mb-6">
                <div className="grid grid-cols-2">
                    ...
                    <div className="bg-white/50 shadow-sm p-4 border border-gray-200">
                        ...
                        <div className="bg-indigo-100 w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center">
                    ...
                    <div className="bg-white/50 shadow-sm p-4 border border-gray-200">
                        ...
                        <div>
                            ...
                            {dashboardState?.scheduledCount}
                            </p>
                        </div>
                        <div className="bg-purple-100 w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center">
                    ...
                    <div className="bg-white/50 shadow-sm p-4 border border-gray-200">
                        ...
                        <div>
                            ...
                            {dashboardState?.rejectedCount}
                            </p>
                        </div>
                        <div className="bg-red-100 w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center">
